...
"""
Input: pointer to a BST, and a number
Output: largest key in the tree which is smaller than the number given
        or -1 if there is no such node

        Find the first node which is less than the given number
        Find the rightmost descendant of the found node
